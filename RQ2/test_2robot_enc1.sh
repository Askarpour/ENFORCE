...
do
	...
	testfile2="Enc1_2robot_M"${mapidentifier[$mapindex]}"_G"$currgridindex".xml"
	...
	python3 ../lib/encoding1xml_2robot.py ../maps/$currentMap  $testfile2 $initposx","$initposy $pointofinterestx1","$pointofinteresty1"@"$pointofinterestx2","$pointofinteresty2"@"$pointofinterestx3","$pointofinteresty3"@"$pointofinterestx5","$pointofinteresty5 "tipoRobot" ${grid[$currgridindex]} ${xmetersize[$mapindex]} $ktime
    ...
    for ((prop=0; prop<$propnum; prop++));
        ...
        if [[ "$prop" -eq "1" ]]; then
            ...
            testname2="Enc1_2robot_M"${mapidentifier[$mapindex]}"_G"$currgridindex"_TN2_P"$prop
			tracefile2="Enc1_2robot_M"${mapidentifier[$mapindex]}"_G"$currgridindex"_TN2_P"$prop".xtr"
        ...
        if [[ "$prop" -eq "2" ]]; then
            ...
            testname2="Enc1_2robot_M"${mapidentifier[$mapindex]}"_G"$currgridindex"_TN3_P"$prop
			tracefile2="Enc1_2robot_M"${mapidentifier[$mapindex]}"_G"$currgridindex"_TN3_P"$prop".xtr"
        ...
        if [[ "$prop" -eq "3" ]]; then
            ...
            testname2="Enc1_2robot_M"${mapidentifier[$mapindex]}"_G"$currgridindex"_TN4_P"$prop
			tracefile2="Enc1_2robot_M"${mapidentifier[$mapindex]}"_G"$currgridindex"_TN4_P"$prop".xtr"
        ...
        if [[ "$prop" -eq "4" ]]; then
	        ...
	        do
                ...
                testname2="Enc1_2robot_M"${mapidentifier[$mapindex]}"_G"$currgridindex"_T"$timebound"_P"$prop"_task1"
